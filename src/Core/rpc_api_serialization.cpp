...
void ser_members(bytecoin::SendProof &v, ISeria &s) {
    const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX = parameters::CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX;  // TODO - hard to get reference to our currency here
	std::string addr;
	if (!s.is_input())
