...
static void cn_slow_hash_runtime_aes_check(void * a, const void * b, size_t c, void * d, int variant){
  if( cpu_has_aesni() )
    cn_slow_hash_aesni(a, b, c, d, variant);
  else
    cn_slow_hash_noaesni(a, b, c, d, variant);
}

static void (*cn_slow_hash_fp)(void *, const void *, size_t, void *, int variant) = cn_slow_hash_runtime_aes_check;

void cn_slow_hash(void * a, const void * b, size_t c, void * d, int variant){
