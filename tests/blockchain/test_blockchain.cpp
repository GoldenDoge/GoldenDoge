...
public:
	...
	TestMiner(BlockChainState &block_chain, const Currency &currency) : block_chain(block_chain), currency(currency) {
		invariant(currency.parse_account_address_string(
                      "QvLyGMm8UqYEnMZeZ7iYsTUQgJNAUeJTJhgShUAe7cKugQVgXzekn4SBBU3UyQHTU9WqY7GQupXxxJSJf446XjDB1qnoXDhi6",
		              &address),
		    "");
        std::vector<std::string> skeys{"8c9f60c319278e2422d9dd6e7a982e15168c0a61bedde52aab47beed20326f0f"};
		for (auto &&sk : skeys) {
